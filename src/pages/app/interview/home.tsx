                ...
                <div className="mb-4 flex-col justify-between gap-4 sm:flex md:flex-row">
                    <div className="hidden gap-4 md:flex">
                        <div className="relative">
                            {/* <button onClick={() => setShowCreateDropdown(!showCreateDropdown)} className="items-center whitespace-nowrap rounded-md text-md font-medium text-slate-500 hover:bg-opacity-90 px-4 py-2 relative flex h-[50px] w-[160px] flex-col justify-between bg-slate-900 md:h-10 md:flex-row" > */}
                            <button onClick={() => setShowInterviewModal(true)} className="items-center whitespace-nowrap rounded-md text-md font-medium text-slate-500 hover:bg-opacity-90 px-4 py-2 relative flex flex-col justify-between bg-sky-500 md:h-10 md:flex-row" >

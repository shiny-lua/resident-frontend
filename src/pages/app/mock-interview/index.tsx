            ...
            <div className="w-full relative flex flex-1 flex-col gap-3 p-4 pb-16 lg:gap-4 lg:p-6 lg:pb-6 md:max-h-screen">
                ...
                <div className="mb-4 flex-col justify-between gap-4 sm:flex md:flex-row">
                    <div className="hidden gap-4 md:flex">
                        <button onClick={() => setShowInterviewModal(!showInterviewModal)} className="whitespace-nowrap flex items-center gap-2 justify-center gap-y-3 rounded-md border border-sky-100 bg-sky-100 p-3 text-sm font-medium text-slate-900 hover:border-slate-900 hover:bg-slate-50 hover:opacity-80">
                            <Icon icon="MockInterview" />
                            <span className="color-[#142C36] text-sm font-medium">
                    ...
                    <div className="flex flex-1 gap-2 md:hidden">
                        <button onClick={() => setShowInterviewModal(true)} className="items-center justify-center whitespace-nowrap rounded-md text-md font-medium bg h-[50px] flex-1 flex-col !bg-design-orange px-4 py-2.5">

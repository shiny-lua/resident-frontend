            ...
            <main className="relative flex h-screen items-center justify-center bg-white">
                <div className="flex h-full flex-col items-center justify-center">
                    ...
                    <div className="px-4 text-center text-lg font-semibold text-slate-900 md:px-0">
                        Well done! You finished your practice interview with our AI Copilot!
                    </div>
                    <div className="text-gray-600 mt-4 px-6 text-center text-sm">
                        View the practice interview report approximately 5 minutes later.
                    </div>
                            ...
                            {status.tabIdx === 0 && (
                                <div className="flex flex-col items-center">
                                    <div className="flex gap-1">
                                        ...
                                        <div className="text-md font-semibold text-slate-900">
                                            How likely are you to recommend our Practice Interview to a friend?
                                        </div>
                                    </div>
                            ...
                            {status.tabIdx === 1 && (
                                <div className="flex flex-col items-center">
                                    <div className="flex gap-1">
                                        ...
                                        <div className="text-md font-semibold text-slate-900">What problem do you want the Practice Interview to help with?</div>
                                    </div>

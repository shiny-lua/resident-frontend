...
const InfoCard = ({ title, desc, buttonText, buttonLink }: { title: string; desc: string; buttonText: string; buttonLink: string }) => {
    return (
        <div className="border flex-1 rounded-md text-slate-700 subpixel-antialiased shadow-none">
            ...
            <div className="p-6 px-6 py-4 pt-0 sm:py-6 sm:pt-0">
                ...
                <button className="inline-flex items-center justify-center rounded-md text-sm ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-0 disabled:pointer-events-none disabled:opacity-50 border border-input bg-background hover:bg-accent hover:text-accent-foreground h-10 px-4 py-2 word-break mt-5 whitespace-break-spaces font-semibold">

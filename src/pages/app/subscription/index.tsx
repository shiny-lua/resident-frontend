                        ...
                        <div className="flex flex-wrap justify-center gap-x-6 gap-y-8">
                            ...
                            <div className="relative flex w-full max-w-[380px] flex-col rounded-lg border border-sky-500 p-6 dt:basis-[45%] dtxl:basis-[30%]">
                                ...
                                <div className="mt-6">
                                    ...
                                    <button className="mt-6 flex items-center justify-center rounded-md font-medium bg-primary hover:bg-primary/90 h-10 py-2 w-full bg-gradient-to-r from-[#0090FF] to-[#00F7FF] text-white">
                                        Subscribe
                                    </button>
                            ...
                            <div className="relative flex w-full max-w-[380px] flex-col rounded-lg border border-slate-200 p-6 dt:basis-[45%] dtxl:basis-[30%]">
                                ...
                                <div className="mt-6">
                                    ...
                                    <button className="mt-6 flex items-center justify-center rounded-md font-medium h-10 py-2 w-full border border-slate-300">
                                        Subscribe
                                    </button>
                                    <ul className="mt-4 space-y-4 border-t pt-6 text-sm">
